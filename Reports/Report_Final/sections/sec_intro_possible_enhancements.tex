...
place and location matching in third. See Figure \ref{fig:init_survey_competency}, Figure \ref{fig:init_survey_location} and Figure \ref{fig:init_survey_time}.

\begin{figure}[ht]
  \caption{Initial Survey Trade offs: Competency} 
  \centering
    \label{fig:init_survey_competency}
    \includegraphics[width=0.5\textwidth]{init_survey_competency.png}
...
\begin{figure}[ht]
  ...
  \centering
    ...
    \includegraphics[width=0.5\textwidth]{init_survey_location.png}
    % \caption{Average Levels for Frustration, Confusion, and Gaming the System per Student across their entire usage of the Tutoring System}
\end{figure}
...
\begin{figure}[ht]
  ...
  \centering
    ...
    \includegraphics[width=0.5\textwidth]{init_survey_time.png}
    % \caption{Average Levels for Frustration, Confusion, and Gaming the System per Student across their entire usage of the Tutoring System}
\end{figure}
